 ...
 */
final class Version20210121084928 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP firstname, DROP lastname, DROP age, DROP size, DROP weight, DROP fat_mass, DROP body_water, DROP muscle_mass, DROP arm_circumference, DROP waist_size, DROP thigh_circumference, DROP ruffier_dickston_test, DROP three, DROP pathology, DROP treatment, DROP prescription, DROP imc');
