...
class CompanyFixtures extends Fixture
{
    ...
    {
        $gym = new Company();
        $gym->setDescription("Aïe, aïe, aïe, j'ai mal à la nuque, au dos, au poignet, à la tête... 
        mais pourquoi ? c'est probablement du à votre position de travail. Suite à un accident, une maladie 
